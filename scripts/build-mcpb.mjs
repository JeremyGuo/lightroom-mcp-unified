...
const outFile = path.join(outDir, "lightroom-mcp-unified.mcpb");
...
copyDir(
  path.join(repoRoot, "plugin", "LightroomMCPUnified.lrplugin"),
  path.join(stage, "LightroomMCPUnified.lrplugin"),
);

copyFile(path.join(repoRoot, "LICENSE"), path.join(stage, "LICENSE"));
copyFile(path.join(repoRoot, "NOTICE.md"), path.join(stage, "NOTICE.md"));
copyFile(path.join(repoRoot, "README.md"), path.join(stage, "README.md"));
copyDir(path.join(repoRoot, "docs"), path.join(stage, "docs"));
copyFile(path.join(repoRoot, "server", "LICENSE"), path.join(dstServer, "LICENSE"));
copyFile(path.join(repoRoot, "server", "README.md"), path.join(dstServer, "README.md"));
...
const result = spawnSync(
  "npx",
  ["--yes", "@anthropic-ai/mcpb@2.1.2", "pack", stage, outFile],
