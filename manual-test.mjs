...
// client. Connects raw sockets to the plugin's request (:58773) and response
// (:58774) ports, sends one action, prints the reply, then exits.
//
...
//   LIGHTROOM_MCP_REQUEST_PORT   default 58773
//   LIGHTROOM_MCP_RESPONSE_PORT  default 58774
//
// Env overrides (probe/server reader only — no matching Plug-in Manager setting):
//   LIGHTROOM_MCP_TOKEN_PATH     default ~/.config/lightroom-mcp-unified/token
//
...
const REQUEST_PORT = Number(process.env.LIGHTROOM_MCP_REQUEST_PORT ?? 58773);
const RESPONSE_PORT = Number(process.env.LIGHTROOM_MCP_RESPONSE_PORT ?? 58774);
const TOKEN_PATH =
